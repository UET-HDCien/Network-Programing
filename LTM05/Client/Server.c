/*
	...
	Student ID:15021363
	Description: Server opens a port(8899) and waits connect from client , accepts maximum 5 connection, Server reads filename from client and send file by socket until EOF,and 
